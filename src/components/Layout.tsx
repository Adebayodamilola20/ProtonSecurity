        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-20 px-4">
            ...
            <Link to="/" className="flex items-center space-x-3">
              <img src={logo} alt="Proton Security Logo" className="w-40 h-40 object-contain" />
              <div>
                  ...
                  >
                    ...
                    {isAboutDropdownOpen && (
                      <div className="absolute top-full left-0 mt-0 pt-2 w-48 z-50">
                        <div className="bg-white text-primary rounded-lg shadow-xl py-2">
                          <Link
                            to="/policy"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/protonsecurityservices" target="_blank" rel="noopener noreferrer" className="hover:text-highlight transition-colors" aria-label="Facebook">
                  <Facebook size={20} />
                </a>
                <a href="https://www.instagram.com/protonsecurityservices/" target="_blank" rel="noopener noreferrer" className="hover:text-highlight transition-colors" aria-label="Instagram">
                  <Instagram size={20} />
                </a>
                <a href="https://x.com/protonsecuritys" target="_blank" rel="noopener noreferrer" className="hover:text-highlight transition-colors" aria-label="Twitter">
                  <Twitter size={20} />
                </a>
                <a href="https://www.linkedin.com/company/protonsecurityservices" target="_blank" rel="noopener noreferrer" className="hover:text-highlight transition-colors" aria-label="LinkedIn">
                  <Linkedin size={20} />
                </a>
              </div>
            </div>
