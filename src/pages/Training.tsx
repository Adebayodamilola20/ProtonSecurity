            ...
            <AnimatedSection delay={200}>
              <div>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Our comprehensive training programs integrate rigorous theoretical instruction with practical, hands-on experience, equipping security professionals to perform effectively in real-world environments.
                </p>
                <p className="text-gray-600 mb-6">
                 Supported by state-of-the-art training facilities, experienced instructors, and a continuously updated curriculum, we have successfully trained over 10,000 security professionals who now serve with distinction in organizations across the globe.
                </p>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                <CardContent className="p-8">
                  <div className="flex items-center space-x-2 mb-6">
                    ...
                    <h3 className="text-xl font-bold text-highlight">Course Modules</h3>
                  </div>
